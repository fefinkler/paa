...
public class PrestadoresDAO implements IDAO {
    ...
    public void popularTabela(JTable tabela, String criterio) {
        ...
        public void popularTabelaServocos(JTable tabela, String criterio) {
        // dados da tabela
        Object[][] dadosTabela = null;
        ...
        try {
            ...
            org.hibernate.Query q = sessao.createQuery("SELECT count(*) FROM servicos_has_prestadores WHERE ref_prestadores ILIKE '%" + criterio + "%' AND delete is null");
            int c = Integer.parseInt(String.valueOf(q.uniqueResult()));
            //int count = (Integer) q.list().get(0);
