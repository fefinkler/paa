 ...
 * @author asimon
 */
public class DlgSelecionarServico extends javax.swing.JDialog {
    ...
    public DlgSelecionarServico(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        servicosDAO = new ServicosDAO();
        servicosDAO.popularTabela(tblServicos, "");
    }

    public DlgSelecionarServico(java.awt.Frame parent, boolean modal, IfrClientes ifrCli) {
        super(parent, modal);
        initComponents();
        servicosDAO = new ServicosDAO();
        servicosDAO.popularTabela(tblServicos, "");
    ...
    public DlgSelecionarServico(java.awt.Frame parent, boolean modal, IfrPrestadores ifrPrest) {
        super(parent, modal);
        initComponents();
        servicosDAO = new ServicosDAO();
        servicosDAO.popularTabela(tblServicos, "");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Consulta de Servicos");
    ...
    private void btnSelecionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSelecionarActionPerformed
        ...
        Servicos ser = (Servicos) servicosDAO.consultarId(id);
            ifrPresClasse.pegaValorServico(ser);
            this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DlgSelecionarServico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DlgSelecionarServico dialog = new DlgSelecionarServico(new javax.swing.JFrame(), true);
