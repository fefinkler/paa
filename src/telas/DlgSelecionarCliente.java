 ...
 * @author asimon
 */
public class DlgSelecionarCliente extends javax.swing.JDialog {
    ...
    public DlgSelecionarCliente(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        clientesDAO = new ClientesDAO();
        clientesDAO.popularTabela(tblClientes, "");
    }

    public DlgSelecionarCliente(java.awt.Frame parent, boolean modal, IfrAgendamentos ifrAgen) {
        super(parent, modal);
        initComponents();
        clientesDAO = new ClientesDAO();
        clientesDAO.popularTabela(tblClientes, "");
    ...
    private void btnSelecionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSelecionarActionPerformed
        ...
        Clientes cli = (Clientes) clientesDAO.consultarId(id);
            ifrAgenClasse.pegaValorCliente(cli);
            this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DlgSelecionarCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DlgSelecionarCliente dialog = new DlgSelecionarCliente(new javax.swing.JFrame(), true);
